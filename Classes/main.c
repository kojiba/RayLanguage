...
rbool stringSerializer(pointer context, pointer object, size_t iterator) {
    ((SerializerData*)((REnumerateDelegate*)context)->context)->size              = ((RCString*)object)->size;
    ((SerializerData*)((REnumerateDelegate*)context)->context)->serializePtrStart = ((RCString*)object)->baseString;
    return yes;
}
...
//    endSockets();
    ...
    RArray *array = RA(RS("Hello moto"), RS("Random"), RS("Lorem ipsum"));
